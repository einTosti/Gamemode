...
public class Messages {
    ...
    public void createMessageFile() {
        ...
        setMessage(sb, config, "no_permission", "%prefix% &cNot enough permissions.");
        setMessage(sb, config, "not_a_player", "%prefix% &rYou have to be a player to use this command!");
        addLine(sb, "");
        ...
        setMessage(sb, config, "gm_configReloaded", "%prefix% &7The config &7was %colour%reloaded&7.");
        addLine(sb, "");
